(function(root){
  ...
  const api={newPet,advance,act,clamp,gainExp,learnMove,expForNext,checkEvolution,evolutionReady,evolve,awardBattle,useItem,isInDaycare,sendToDaycare,DAYCARE_DURATION};root.PokeState=api;if(typeof module!=='undefined')module.exports=api;
